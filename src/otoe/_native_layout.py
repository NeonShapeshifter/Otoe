...
from ._native_layout_align import (
    align_stack_children,
    offset_box_y,
    validate_alignment_support,
)
...
def _layout_widget(
    ...
    *,
    ...
    validate_alignment_support(name, style, context)
    ...
    *,
    ...
    if widget.name == "ScrollView":
        ...
        if clamped_scroll_y != scroll_y:
            children = [
                offset_box_y(child, scroll_y - clamped_scroll_y)
