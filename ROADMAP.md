...
- Make the renderer support matrix executable through tests and documented through `NATIVE_RENDERER_SPIKE.md`.
- Clarify which style properties are supported, ignored, rejected, or reserved.
